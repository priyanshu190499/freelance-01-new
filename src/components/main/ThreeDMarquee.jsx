...
// ✅ Utility: you can replace `cn` with `clsx`
const cn = (...args) => clsx(args);

export const ThreeDMarquee = ({ images, className }) => {
  // Split images into 4 equal chunks
  ...
  return (
    <div
      className={cn(
         " relative mx-auto block  h-[100vh] overflow-hidden max-md:h-150 max-sm:h-150",
        className
      )}
    >
      <div className="flex size-full items-center justify-center">
        <div className="size-[1720px] shrink-0 scale-50 sm:scale-75 lg:scale-100">
          <div
            ...
            className="relative top-96 left-[50%] grid size-full origin-top-left grid-cols-4 gap-8 transform-3d"
          >
